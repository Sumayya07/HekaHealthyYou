//
//  PostPregnancyViewController.swift
//  Heka Healthy You
//
//  Created by saeem.
//
...
class PostPregnancyViewController: MenuViewController, UITextFieldDelegate {
    
    @IBOutlet var btnSOS: UIButton!
    @IBOutlet var btnSchedule: UIButton!
    
    @IBOutlet var btnPlan1: UIButton!
    @IBOutlet var btnPlan2: UIButton!
    @IBOutlet var btnPlan3: UIButton!
    ...
    override func viewDidLoad() {
        ...
        btnPlan1.layer.cornerRadius = 8
        btnPlan2.layer.cornerRadius = 8
        btnPlan3.layer.cornerRadius = 8
    ...
    @IBAction func btnBasicPlanTapped(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "BasicViewController") as! BasicViewController
        self.navigationController?.pushViewController(vc, animated: true)
    }
    
    
    @IBAction func btnStandardPlanTapped(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "StandardViewController") as! StandardViewController
        self.navigationController?.pushViewController(vc, animated: true)
    }
    
    
    @IBAction func btnOptimalPlanTapped(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "OptimalViewController") as! OptimalViewController
        self.navigationController?.pushViewController(vc, animated: true)
    }
}
