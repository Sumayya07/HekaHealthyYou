//
//  PrenatalCareViewController.swift
//  Heka Healthy You
//
//  Created by saeem.
//
...
class PrenatalCareViewController: MenuViewController, UITextFieldDelegate {
    ...
    @IBAction func btn3MonthTapped(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "ThreeMonthViewController") as! ThreeMonthViewController
        self.navigationController?.pushViewController(vc, animated: true)
    }
    ...
    @IBAction func btn6MonthTapped(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "SixMonthViewController") as! SixMonthViewController
        self.navigationController?.pushViewController(vc, animated: true)
    }
    
    @IBAction func btn9MonthTapped(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "NineMonthViewController") as! NineMonthViewController
        self.navigationController?.pushViewController(vc, animated: true)
    }
}
