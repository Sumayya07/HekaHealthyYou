...
//  Heka Healthy You
//
//  Created by saeem  on 26/09/23.
//

import UIKit

class LabVC: MenuViewController {
...
//    @IBOutlet var lblChooseFour: NSLayoutConstraint!
    ...
    var safetyImages: [String] = ["Why"]
    var serviceImages: [String] = ["Testing1", "Testing2", "Testing3", "Testing4"]
    var serviceNames: [String] = ["CBC Testing", "Blood Sugar Testing", "Electrolyte Testing", "Creatine"]
...
extension LabVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == safetyCollectionView {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LabTestSafetyCVC", for: indexPath) as! LabTestSafetyCVC
            cell.imgSafetyTraining.image =  UIImage(named: safetyImages[indexPath.row])
            return cell
        } else {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LabTestServiceCVC", for: indexPath) as! LabTestServiceCVC
