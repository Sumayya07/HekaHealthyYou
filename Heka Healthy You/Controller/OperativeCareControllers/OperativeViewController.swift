...
class OperativeViewController: MenuViewController {
    ...
    var safetyImages: [String] = ["ImgOperative"]
    var serviceImages: [String] = ["Op1", "Op2", "Op2", "Op4"]
    var serviceNames: [String] = ["Injury Management", "Chronic Pain Management", "Cardiac Rehabilitation", "Wound Care & Infection Control"]
...
extension OperativeViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == safetyCollectionView {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "OperativeSafetyCVC", for: indexPath) as! OperativeSafetyCVC
            cell.imgSafetyTraining.image =  UIImage(named: safetyImages[indexPath.row])
            return cell
        } else {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "OperativeServiceCVC", for: indexPath) as! OperativeServiceCVC
