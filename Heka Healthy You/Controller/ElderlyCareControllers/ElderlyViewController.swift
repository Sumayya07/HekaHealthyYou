...
class ElderlyViewController: MenuViewController {
    ...
    var safetyImages: [String] = ["ElderlyCareService"]
    var serviceImages: [String] = ["Caregiver", "Clinical", "CareHome", "Physio", "Recovery"]
    var serviceNames: [String] = ["Caregiver", "Clinical Care", "Care at home", "Physiotheraphy", "Recovery"]
...
extension ElderlyViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == safetyCollectionView {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ElderlyCareSafetyCVC", for: indexPath) as! ElderlyCareSafetyCVC
            cell.imgSafetyTraining.image =  UIImage(named: safetyImages[indexPath.row])
            return cell
        } else {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ElderlyCareServiceCVC", for: indexPath) as! ElderlyCareServiceCVC
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if collectionView == serviceCollectionView {
            if indexPath.item == 0 {
                let vc = storyboard?.instantiateViewController(withIdentifier: "CaregiverViewController") as! CaregiverViewController
                self.navigationController?.pushViewController(vc, animated: true)
                
            } else if indexPath.item == 1 {
                let vc = storyboard?.instantiateViewController(withIdentifier: "ClinicalCareViewController") as! ClinicalCareViewController
                self.navigationController?.pushViewController(vc, animated: true)
            } else if indexPath.item == 2 {
                let vc = storyboard?.instantiateViewController(withIdentifier: "CareAtHomeViewController") as! CareAtHomeViewController
                self.navigationController?.pushViewController(vc, animated: true)
            } else if indexPath.item == 3 {
                let vc = storyboard?.instantiateViewController(withIdentifier: "PhysiotheraphyViewController") as! PhysiotheraphyViewController
                self.navigationController?.pushViewController(vc, animated: true)
            } else {
