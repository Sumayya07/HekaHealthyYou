...
class MedicalAstrologyVC: MenuViewController {
...
extension MedicalAstrologyVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
